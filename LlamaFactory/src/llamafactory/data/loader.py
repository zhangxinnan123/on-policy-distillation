...
def _load_single_dataset(
    ...
    if dataset_attr.load_from == "ms_hub":
        ...
        try:
            ...
            if "DatasetGenerationError" not in str(type(e)):
                raise
            logger.warning_rank0(
                f"Failed to load {data_path} via parquet scanner ({e}). "
                "Retrying with streaming mode to bypass pyarrow nested-type bug..."
            )

...
EXP_NAME="fsdp/student-${STUDENT_MODEL}/teacher-${TEACHER_MODEL}/loss-${DISTILLATION_LOSS_MODE}/pg-${USE_POLICY_GRADIENT}__${advantage_mask_high}_b${train_batch_size}_n${ROLLOUT_N}_lr${LR}"
...
DISTILLATION=(
    ...
    distillation.teacher_model.inference.gpu_memory_utilization=0.9

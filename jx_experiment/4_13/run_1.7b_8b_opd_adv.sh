...
## advantage clip
advantage_mask_low=-1
advantage_mask_high=0.1

EXP_NAME="fsdp/student-${STUDENT_MODEL}/teacher-${TEACHER_MODEL}/loss-${DISTILLATION_LOSS_MODE}/pg-${USE_POLICY_GRADIENT}_adv_mask-${advantage_mask_low}_${advantage_mask_high}_b${train_batch_size}_n${ROLLOUT_N}_lr${LR}"
...
STUDENT=(
    ...
    actor_rollout_ref.actor.advantage_mask_low=${advantage_mask_low}
    actor_rollout_ref.actor.advantage_mask_high=${advantage_mask_high}
)

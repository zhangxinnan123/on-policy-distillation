...
EXP_NAME="fsdp/student-${STUDENT_MODEL}/teacher-${TEACHER_MODEL}/loss-${DISTILLATION_LOSS_MODE}/pg-${USE_POLICY_GRADIENT}_advpercent${advantage_mask_percent}_b${train_batch_size}_n${ROLLOUT_N}_lr${LR}"

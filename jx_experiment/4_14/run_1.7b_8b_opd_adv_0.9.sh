...
## advantage mask (percentile-based)
advantage_mask_percent=0.9  # mask middle 90% of advantages (5th–95th pct); keep bottom/top 5%

EXP_NAME="fsdp/student-${STUDENT_MODEL}/teacher-${TEACHER_MODEL}/loss-${DISTILLATION_LOSS_MODE}/pg-${USE_POLICY_GRADIENT}_advpercent${advantage_mask_percent}_b${train_batch_size}_n${ROLLOUT_N}_lr${LR}_normall"
...
STUDENT=(
    ...
    actor_rollout_ref.actor.advantage_mask_percent=${advantage_mask_percent}
)

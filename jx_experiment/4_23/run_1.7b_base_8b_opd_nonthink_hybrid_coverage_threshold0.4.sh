...
HYBRID_MASK_COVERAGE_THRESHOLD=0.4  # Coverage threshold for PG vs supervised routing  
...
EXP_NAME="fsdp/student-${STUDENT_MODEL}/teacher-${TEACHER_MODEL}/loss-${DISTILLATION_LOSS_MODE}/mask-coverage_p${HYBRID_MASK_TOP_P}_t${HYBRID_MASK_COVERAGE_THRESHOLD}_pg${PG_LOSS_COEF}_sup${SUPERVISED_LOSS_COEF}_b${train_batch_size}_n${ROLLOUT_N}_lr${LR}_reslen${MAX_RESPONSE_LENGTH}_nonthink"

...
FAMILY="Qwen"
STUDENT_MODEL=lzy337/lzy-qwen3-4b-base-sft-openthoughts3
...
HYBRID_MASK_STRATEGY="opd_theory_guided3"
...
HYBRID_MASK_FKL_VOTE_THRESHOLD=0.3       # mass-weighted FKL vote → position
...
HYBRID_MASK_USE_DIRECTION_RULE=False
...
EXP_NAME="fsdp/student-${STUDENT_MODEL}/teacher-${TEACHER_MODEL}/loss-${DISTILLATION_LOSS_MODE}/mask-${HYBRID_MASK_STRATEGY}_p${HYBRID_MASK_TEACHER_TOP_P}_elo${HYBRID_MASK_EPS_LOW}_ehi${HYBRID_MASK_EPS_HIGH}_vote${HYBRID_MASK_FKL_VOTE_THRESHOLD}_sfloor${HYBRID_MASK_SAMPLED_OVERSHOOT_FLOOR}_b${train_batch_size}_n${ROLLOUT_N}_lr${LR}_reslen${MAX_RESPONSE_LENGTH}_direction_${HYBRID_MASK_USE_DIRECTION_RULE}"

...
# Student: our 100k-SFT'd Qwen3-1.7B-Base (thinking mode)
...
EXP_NAME="opd/1p7b_sft_100k_teacher_8b/k1_b${train_batch_size}_n${ROLLOUT_N}_lr${LR}_reslen${MAX_RESPONSE_LENGTH}"

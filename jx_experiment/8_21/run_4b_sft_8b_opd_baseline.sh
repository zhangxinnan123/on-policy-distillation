...
############################ OPD baseline — 4B SFT student (thinking) ############################
# Student: our 100k-SFT'd Qwen3-4B-Base (thinking mode)
...
FAMILY="Qwen"
STUDENT_MODEL=/fsx/xinnanzh/checkpoints/sft_qwen3_4b_thinking_100k
...
EXP_NAME="opd/4b_sft_100k_teacher_8b/k1_b${train_batch_size}_n${ROLLOUT_N}_lr${LR}_reslen${MAX_RESPONSE_LENGTH}"
...
echo "================== OPD baseline (4B SFT + Qwen3-8B teacher) =================="

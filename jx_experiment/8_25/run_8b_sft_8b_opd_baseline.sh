...
FAMILY="Qwen"
STUDENT_MODEL=/fsx/xinnanzh/checkpoints/sft_qwen3_8b_thinking_100k
...
EXP_NAME="opd/8b_sft_100k_teacher_8b/k1_b${train_batch_size}_n${ROLLOUT_N}_lr${LR}_reslen${MAX_RESPONSE_LENGTH}"

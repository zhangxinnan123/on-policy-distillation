...
EXP_NAME="opd/1p7b_400k1ep_teacher_8b/fklhybrid_respool_aopd_thr${HYBRID_MASK_AOPD_THRESHOLD}_b${train_batch_size}_n${ROLLOUT_N}_lr${LR}_reslen${MAX_RESPONSE_LENGTH}"

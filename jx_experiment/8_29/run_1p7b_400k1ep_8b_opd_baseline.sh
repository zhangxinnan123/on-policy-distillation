...
############################ OPD baseline — 1.7B SFT student (thinking) ############################
# Student: xinnan_400k_1ep — 1.7B SFT on openthoughts3 400k (HF-downloaded, rope OK)
...
EXP_NAME="opd/1p7b_400k1ep_teacher_8b/k1_b${train_batch_size}_n${ROLLOUT_N}_lr${LR}_reslen${MAX_RESPONSE_LENGTH}"
...
echo "================== OPD baseline (1.7B SFT + Qwen3-8B teacher) =================="

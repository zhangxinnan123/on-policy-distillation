...
############################ AOPD threshold=0 — 4B ot400k SFT student ############################
# Routing:
...
EXP_NAME="opd/4b_ot400k_teacher_8b/aopd_thr${HYBRID_MASK_AOPD_THRESHOLD}_b${train_batch_size}_n${ROLLOUT_N}_lr${LR}_reslen${MAX_RESPONSE_LENGTH}"

...
############################ OPD baseline — 4B ot400k SFT student (thinking) ############################
# Student: our openthoughts3-400k-SFT'd Qwen3-4B-Base (sft_qwen3_4b_ot400k)
# Teacher: Qwen3-8B (thinking mode, same as SFT data gen)
# Loss: k1_topk_overlap (single-sample KL, matches 8/9 baseline scripts)
# Mask: none (all-token PG — the standard OPD baseline)
...
EXP_NAME="opd/4b_ot400k_teacher_8b/k1_b${train_batch_size}_n${ROLLOUT_N}_lr${LR}_reslen${MAX_RESPONSE_LENGTH}"
...
DISTILLATION=(
    ...
    distillation.teacher_model.inference.gpu_memory_utilization=0.45
...
echo "================== OPD baseline (4B ot400k SFT + Qwen3-8B teacher) =================="
echo "STUDENT: $STUDENT_MODEL"
echo "TEACHER: $TEACHER_MODEL"
echo "LOSS: $DISTILLATION_LOSS_MODE (topk=16)"
echo "use_policy_gradient=$USE_POLICY_GRADIENT (all-token PG)"
echo "======================================================================="

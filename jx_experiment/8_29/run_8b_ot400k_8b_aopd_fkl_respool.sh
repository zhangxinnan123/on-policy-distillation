...
############################ AOPD threshold=0 — 8B ot400k SFT student ############################
# Routing:
...
EXP_NAME="opd/8b_ot400k_teacher_8b/fklhybrid_respool_aopd_thr${HYBRID_MASK_AOPD_THRESHOLD}_b${train_batch_size}_n${ROLLOUT_N}_lr${LR}_reslen${MAX_RESPONSE_LENGTH}"
...
echo "================== 8B ot400k SFT + AOPD thr=$HYBRID_MASK_AOPD_THRESHOLD =================="

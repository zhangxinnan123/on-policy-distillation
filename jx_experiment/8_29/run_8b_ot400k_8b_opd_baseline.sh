...
############################ OPD baseline — 8B ot400k SFT student (thinking) ############################
# Student: sft_qwen3_8b_ot400k — 8B SFT on openthoughts3 400k (+boxed suffix, official hp)
...
EXP_NAME="opd/8b_ot400k_teacher_8b/k1_b${train_batch_size}_n${ROLLOUT_N}_lr${LR}_reslen${MAX_RESPONSE_LENGTH}"
...
echo "================== OPD baseline (8B ot400k SFT + Qwen3-8B teacher) =================="

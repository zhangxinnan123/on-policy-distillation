...
############################ teacher_topk_entropy τ=1.6 — 8B ot400k SFT student ############################
# Routing:
...
EXP_NAME="opd/8b_ot400k_teacher_8b/tent_tau${HYBRID_MASK_TENT_THRESHOLD}_b${train_batch_size}_n${ROLLOUT_N}_lr${LR}_reslen${MAX_RESPONSE_LENGTH}"

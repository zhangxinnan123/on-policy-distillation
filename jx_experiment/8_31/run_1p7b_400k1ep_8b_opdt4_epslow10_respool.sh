...
############################ OPD-theory-guided4 vote=0.3 — 1.7B SFT student ############################
# Routing:
...
# vote=0.3: best-observed in the 8B-Base sweep (not statistically separated).
HYBRID_MASK_COVERAGE_THRESHOLD=0.2
HYBRID_MASK_FKL_VOTE_THRESHOLD=0.3
HYBRID_MASK_EPS_LOW=10   # R2 门槛 pi_T/pi_S > 11 (基准 0.5 -> >1.5)
...
EXP_NAME="opd/1p7b_400k1ep_teacher_8b/fklhybrid_respool_opdt4_vote${HYBRID_MASK_FKL_VOTE_THRESHOLD}_epslow${HYBRID_MASK_EPS_LOW}_b${train_batch_size}_n${ROLLOUT_N}_lr${LR}_reslen${MAX_RESPONSE_LENGTH}"
...
echo "================== 1.7B SFT + OPDT4 vote=$HYBRID_MASK_FKL_VOTE_THRESHOLD =================="

...
EXP_NAME="opd/1p7b_400k1ep_teacher_8b/fklhybrid_opdt4_vote${HYBRID_MASK_FKL_VOTE_THRESHOLD}_cov${HYBRID_MASK_COVERAGE_THRESHOLD}_epslow${HYBRID_MASK_EPS_LOW}_tp${HYBRID_MASK_TEACHER_TOP_P}_b${train_batch_size}_n${ROLLOUT_N}_lr${LR}_reslen${MAX_RESPONSE_LENGTH}"
...
echo "===== 1.7B SFT + opdt4 vote=$HYBRID_MASK_FKL_VOTE_THRESHOLD cov=$HYBRID_MASK_COVERAGE_THRESHOLD eps_low=$HYBRID_MASK_EPS_LOW top_p=$HYBRID_MASK_TEACHER_TOP_P ====="

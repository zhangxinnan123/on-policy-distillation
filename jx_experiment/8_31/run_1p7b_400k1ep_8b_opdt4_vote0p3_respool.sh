...
EXP_NAME="opd/1p7b_400k1ep_teacher_8b/fklhybrid_respool_opdt4_vote${HYBRID_MASK_FKL_VOTE_THRESHOLD}_b${train_batch_size}_n${ROLLOUT_N}_lr${LR}_reslen${MAX_RESPONSE_LENGTH}"

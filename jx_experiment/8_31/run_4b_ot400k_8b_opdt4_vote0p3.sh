...
EXP_NAME="opd/4b_ot400k_teacher_8b/fklhybrid_opdt4_vote${HYBRID_MASK_FKL_VOTE_THRESHOLD}_b${train_batch_size}_n${ROLLOUT_N}_lr${LR}_reslen${MAX_RESPONSE_LENGTH}"

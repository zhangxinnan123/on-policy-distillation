...
HYBRID_MASK_EPS_LOW=9   # R2 门槛 pi_T/pi_S > 10  (1+eps_low)
...
EXP_NAME="opd_ablate/1p7b_base_8b/opdt4_r2only_vote${HYBRID_MASK_FKL_VOTE_THRESHOLD}_cov${HYBRID_MASK_COVERAGE_THRESHOLD}_ratio10_b${train_batch_size}_n${ROLLOUT_N}_lr${LR}_reslen${MAX_RESPONSE_LENGTH}"

...
EXP_NAME="opd_ablate/1p7b_base_8b/opdt5_r3only_rlow${HYBRID_MASK_RATIO_LOW}_rhigh${HYBRID_MASK_RATIO_HIGH}_floor${HYBRID_MASK_OVERSHOOT_FLOOR}_vote${HYBRID_MASK_FKL_VOTE_THRESHOLD}_b${train_batch_size}_n${ROLLOUT_N}_lr${LR}_reslen${MAX_RESPONSE_LENGTH}"

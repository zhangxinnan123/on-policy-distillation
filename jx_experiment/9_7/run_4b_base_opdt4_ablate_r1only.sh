...
EXP_NAME="opd_ablate/4b_base_8b/opdt4_r1only_vote${HYBRID_MASK_FKL_VOTE_THRESHOLD}_cov${HYBRID_MASK_COVERAGE_THRESHOLD}_eps${HYBRID_MASK_EPS_LOW}_b${train_batch_size}_n${ROLLOUT_N}_lr${LR}_reslen${MAX_RESPONSE_LENGTH}"

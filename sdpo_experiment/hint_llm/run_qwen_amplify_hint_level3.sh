...
EXP_NAME=${EXP_NAME:-qwen_deepmath_amplify_gamma${AMPLIFY_GAMMA}_ppoMinClip_epsLo${PPO_CLIP_LOW}_epsHi${PPO_CLIP_HIGH}_fixedRegC${REGIME_C_SCALE:-1.0}_n${N_HINT}_hint${HINT_LEVEL}_${DATE_TAG}}

...
def main():
    ...
    p.add_argument("--input", default="lzy_eval_result/teacher_inference/20260411-051628_results/20260411-204130_Qwen3-8B_scored_1.jsonl", help="Path to scored .jsonl file.")
    p.add_argument("--teacher", default="Qwen3-8B", help="Teacher model name (e.g. OpenThinker3-7B).")
    p.add_argument("--student", default="Qwen3-1.7B", help="Student model name (e.g. Qwen3-4B-SFT).")
